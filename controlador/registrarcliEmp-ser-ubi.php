...
$var=0;
	...
	if($datosF->RegistrarUbicacionesEmpresariales($cod_ubi,$nombre_ubi,$direccion_ubi,$municipio_ubi,$nombre_per_ubi,$apellido_per_ubi,$telefono_ubi,$celular_ubi,$email_ubi,$cod_dat)){
