...
if($datosF->ActualizarUbicacionesCliPer($datosF->nombreubi, $datosF->direccionubi, $datosF->municipioubi, $datosF->nombre_per_ubi, $datosF->apellido_per_ubi, $datosF->telefono_per_ubi, $datosF->celular_per_ubi, $datosF->email_per_ubi, $datosF->cod_ubi)){
