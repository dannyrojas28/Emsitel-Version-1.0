...
if(mysqli_num_rows($query2) > 0){
	...
	if($datosF->RegistrarUbicacionServicio($cod_ubi,$nombre_ubi,$direccion_ubi,$municipio_ubi,$datosF->nombre_per_ubi,$apellido_per_ubi,$telefono_ubi,$celular_ubi,$email_ubi,$cod_dat)){
    	 echo "true+";?> <br><center>
