...
<form name="formulario2" enctype="multipart/form-data">
     ...
     <br>
                                                            ...
                                                            $num_ip1=0;
                                                             if($palabra != 0){
                                                               ...
                                                               $query=$datosF->BD_IpBakbone();
                                                                ...
                                                                <input type="number"  class="form-control input-group-addon"   maxlength='3' onkeyup="javascript:validateIp('direccionIp<?php echo $cod; ?>','descripcionIp<?php echo $cod; ?>')" name="direccionIp<?php echo $cod; ?>"id="sm2" value="<?php echo $num_ip1;?>">
                                                        </div>
                                                     </div>  
                           
                                                          <div class="col-xs-5">
                                                                <label id="examplePass">Descripcion</label><br>
                                                                <input type="text" class="form-control"  placeholder="Descripcion Ip 1" name="descripcionIp<?php echo $cod; ?>"id="descripcionIp<?php echo $cod; ?>"  value="<?php echo $rowc['descripcion_bak_emp']; ?>" >
                                                                <br>
                                                         </div>
                                                  </div>                   
                             <?php
                                    ...
                                    <div class="col-xs-7">
                                         ...
                                         <label id="examplePass">Direccion Ip <?php echo $codc;?></label>
                                          <div class="input-group">
                                             ...
                                             <input type="number"  class="form-control input-group-addon"   maxlength='3' onkeyup="javascript:validateIp('direccionIpc<?php echo $codc; ?>','descripcionIpc<?php echo $codc; ?>')" name="direccionIpc<?php echo $codc; ?>"id="sm2" value="<?php echo $num_ip; ?>">
                                       </div>
                                         </div>
                                    
                                    <div class="col-xs-5">
                                        <label id="examplePass">Descripcion</label>
                                        <input type="text" class="form-control" placeholder="Descripcion Ip 1" name="descripcionIpc<?php echo $codc; ?>"id="descripcionIpc<?php echo $codc; ?>" value="<?php echo $rowc['descripcionip_cli_emp']; ?>">
                                        <br>
                                    </div>
                                <br>
                             </div>
                          ...
                          <div class="form-group">  <br>
                            ...
                            <div class="col-xs-6">
                                <label id="examplePass">Direccion Mac/Serial</label><br> 
                                    <input type="text" class="form-control"  name="direccionmac<?php echo $code;?>"id="direccioncmac<?php echo $code;?>" value="<?php echo $rowc['mac_emp'];?>"> 
                                <br>
                            </div>
                            ...
                            <div class="col-xs-12 ">
                                <label id="examplePass">Descripcion</label>
                                <input type="text" class="form-control" placeholder="descripcion serial" id="descripcionserial<?php echo $code;?>" name="descripcionserial<?php echo $code;?>" value="<?php echo $rowc['descripcion_emp'];?>">
                                <br>
                             </div>
                        </div>
                 <?php
                ...
                <center>
                     <button type="button" id="btn" name="btn" onclick="RegistrarCliPerServicioUbicacion('controlador/actualizarserviciosempresariales.php')" class="btn btn-primary"> <span class="glyphicon glyphicon-refresh"></span>   Actualizar</button> <br>
                    <br>               
                </center>
                </div>
</form>
