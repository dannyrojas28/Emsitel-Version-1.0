    ...
    document.getElementById('tiposervicio').focus();
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <textarea type="text" class="form-control" placeholder="Descripcion del contrato" id="descripcion_contrato" name="descripcion_contrato" value=""></textarea>
...
$numeroA=0;
                ...
                <center>
                    <?php
                     if($_SESSION['cliente'] == "personal"){
                    ?>
                     <button type="button" id="btn" name="btn" onclick="RegistrarCliPerServicioUbicacion('controlador/registrarcliper-ser-ubi.php')" class="btn btn-primary"> <span class="glyphicon glyphicon-share-alt"></span>   Registrar</button> <br>
                   <?php
                     }else{
                     ?>
                     <button type="button" id="btn" name="btn" onclick="RegistrarCliPerServicioUbicacion('controlador/registrarcliEmp-ser-ubi.php')" class="btn btn-primary"> <span class="glyphicon glyphicon-share-alt"></span>   Registrar</button> <br>
                     <?php
