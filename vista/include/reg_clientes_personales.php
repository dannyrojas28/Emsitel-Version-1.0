...
<div id="row">
    <div id="col-xs-offset-1 col-xs-11">
        <div class="col-sm-12 col-xs-12">
            <div class="col-xs-12">
                <!-- se mostrara el boton de nuevo registro personal en la parte superior derecha de la pantalla -->
                <button type="button" onclick="CargarSubContenido('vista/include/nuevo_registro_personal')" class="btn btn-success float"><span class="glyphicon glyphicon-plus-sign"></span>  Nuevo Registro</button>
                <br>
                
            </div>
            <h2>Clientes Personales</h2><br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10 col-sm-5 ">    
                        ...
                        <input type="text" class="form-control" placeholder="Digite su busqueda" onkeyup="FiltroClientesPersonales()" id="palabra">
            ...
            <div id="consultaClientesPersonales">
            </div>
...
<script type="text/javascript">
 ...
 var parametro={'parama':1};
    ...
    data:parametro,
     type:"POST",
     url:"controlador/consulta25clientespersonales.php",
     beforeSend:function(){
        document.getElementById('consultaClientesPersonales').innerHTML="<br><center><h3><span class='glyphicon glyphicon-dashboard'>  Cargando</span></h3></center>";
    },
       success:function(response){
            document.getElementById('consultaClientesPersonales').innerHTML=response;
            
       }

    });
    //Al presionar una tecla se ejecuta esta funcion en la barra de busqueda se ejecutara esta funcion
    function FiltroClientesPersonales(){
        ...
        if(palabra.length > 3){
            ...
            data:parametro,
             type:"POST",
             url:"controlador/FiltroClientesPersonales.php",
                beforeSend:function(){
                       document.getElementById('consultaClientesPersonales').innerHTML="<br><center><h3><span class='glyphicon glyphicon-dashboard'>  Cargando</span></h3></center>";
                 },
                success:function(response){
                    ...
                    if(print[0] == "true"){
                     document.getElementById('consultaClientesPersonales').innerHTML=print[1];
                    }else{
                        document.getElementById('consultaClientesPersonales').innerHTML="<br><center>no se han encontrado Resultados</center><br>";
                    }
                }
